class vendingMachine {
    ...
    displayInventory() {
        let inventoryItemValues = this.inventory.itemInventory;
        let inventoryCoinValues = this.inventory.coinInventory;
        if (this.inventory) {
            console.log(inventoryItemValues)
            console.log(inventoryCoinValues)
        }
    }
